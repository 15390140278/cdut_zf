...
<template>
  <div>
    <el-breadcrumb separator="/">
      <el-breadcrumb-item>提交发布租房申请</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card>
      <el-form :model="publishForm" class="publish_form" ref="publishFormRef" label-width="100px" :rules="publishFromRules">
        <el-form-item label="房屋标题" prop="title">
          <el-input placeholder="请输入房屋标题" v-model="publishForm.title"></el-input>
        </el-form-item>
        ...
        <el-form-item label="租房价格" prop="priceNum">
          <el-input placeholder="请输入价格" v-model="publishForm.priceNum"></el-input>
        </el-form-item>
        <el-form-item label="面积" prop="size">
          <el-input placeholder="请输入面积" v-model="publishForm.size"></el-input>
        </el-form-item>
        <el-form-item label="房屋详情" prop="detail">
          <el-input type="textarea" :rows="2" placeholder="请输入内容" v-model="publishForm.detail"></el-input>
        </el-form-item>
  ...
  methods: {
    addHouse() {
      this.$refs.publishFormRef.validate(async valid => {
        ...
        const { data: res } = await this.$http.post('house/add', this.qs.stringify(this.publishForm))
        if (res.code !== 200) {
          console.log(res.msg)
